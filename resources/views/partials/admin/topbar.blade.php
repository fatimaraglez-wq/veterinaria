    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="adminDropdown" role="button"
                ...
                <img class="img-profile rounded-circle" src="/startbootstrap/img/undraw_profile.svg" alt="Perfil Admin">
            </a>

            {{-- Dropdown - User Information --}}
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="adminDropdown">
                <div class="dropdown-header bg-light py-2 px-4">
