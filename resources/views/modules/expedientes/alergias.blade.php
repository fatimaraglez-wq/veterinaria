...
@section('contenido')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-allergies mr-2 text-info"></i> Alergias: <span class="text-primary">{{ $mascota->nombre }}</span>
        </h1>
            ...
            <div class="card shadow mb-4 border-left-info">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-white">
                    <h6 class="m-0 font-weight-bold text-info">
                        <i class="fas fa-allergies mr-2"></i>Registro de Alergias
                    </h6>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('expedientes.mascotas.alergias.update', $mascota->id) }}" method="POST" id="form-alergias">
                        @csrf
                        
                        <div class="form-group mb-4">
                            <label class="font-weight-bold text-gray-700" style="font-size: 1.1rem;">Descripción de alergias (medicamentos, alimentos, etc.):</label>
                            
                            {{-- Quill Editor Container --}}
                            <div id="editor-container" style="height: 300px; font-size: 1.1rem;">
                                {!! old('alergias', $mascota->alergias) !!}
                            </div>
                            
                            {{-- Hidden input to store Quill content for form submission --}}
                            <input type="hidden" id="alergias" name="alergias" value="{{ old('alergias', $mascota->alergias) }}">
                        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var form = document.getElementById('form-alergias');
            var hiddenInput = document.getElementById('alergias');
